    ...
    <div class="layui-layout layui-layout-admin">
      <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
		  ...
		  <li class="layui-nav-item" lay-unselect id="new_msg" style="display:none;">
            <a lay-href="<?php echo U('system/auth_upgrade');?>" layadmin-event="message" lay-text="点击升级" >
              <i class="layui-icon layui-icon-notice"></i>&nbsp;&nbsp;<font id="new_msg_tip"></font>
              <!-- 如果有新消息，则显示小圆点 -->
          ...
          <li class="layui-nav-item" lay-unselect>
            <a href="javascript:;">
              <cite><?php  if( $_W['role'] == 'agenter' ) { $supper_info = json_decode(base64_decode($_GPC['__lionfish_comshop_agent']), true); echo $supper_info['shopname']; }else{ echo D('Home/Front')->get_config_by_name('shoname'); } ?></cite>
            </a>
